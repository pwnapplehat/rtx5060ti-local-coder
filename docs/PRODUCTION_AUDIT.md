...
| Layer | Choice |
| --- | --- |
| Runtime | llama.cpp `llama-server` (CUDA Windows) |
| Coding quants | Unsloth **UD-Q4_K_XL** |
| Implement | `qwen3coder30b` |
| Plan | `qwen3635b` |
...
- Cold-load after plan ↔ implement switch can take minutes
